...
public class Solution {
    public static void main(String[] args) throws IOException
    {
        ...
        for (int i = 0; i < parsed.length; i++)
        {
            ...
            {
                boolean found = false;
                for (char c : currentArgArr[1].toCharArray())
                {
                ...
                if(found){ alert(Double.parseDouble(currentArgArr[1]));}       //TODO ITS parsing, and its really hard to understand
                else{alert(currentArgArr[1]);}
            }
        }}
