    ...
    public static class DataAdapter implements RowItem{
        ...
        public String getCountryCode() {
            ...
            for(Map.Entry<String, String> a: countries.entrySet()){
                if (a.getValue().equals(cs.getCountryName())){
        ...
        {
            return cs.getCompanyName();
        }

        @Override
        public String getContactFirstName()
        {
            return ct.getName().split(", ")[1];
        }

        @Override
        public String getContactLastName()
        {
            return ct.getName().split(", ")[0];
        }

        @Override
        public String getDialString()
        {
            return "callto://+" + ct.getPhoneNumber().replaceAll("[^0-9]", "");
        }
    }
