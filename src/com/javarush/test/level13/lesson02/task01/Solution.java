...
public class Solution
{
    ...
    public static class Beer implements Alcohol
    {
        ...
        {
            System.out.println("Give to me this beer");
        }

        @Override
        public void sayThankYou()
        {
            System.out.println("Thanks to you, motherfucker");
        }

        @Override
        public boolean isReadyToGoHome()
        {
            System.out.println("Not at this time");
            return false;
        }
        ...
        {
            System.out.println("My pants smells bad");
        }
    }
}
