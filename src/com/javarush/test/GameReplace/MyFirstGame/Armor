...
public class Armor
{
    ...
    public String Who(HashMap<Integer, ArmorComplect> hehe)
    {
        String then = "";
        for (HashMap.Entry<Integer, ArmorComplect> map : hehe.entrySet()
                )
        {
    ...
    public void ArmorChooserV2()
    {
        ...
        {
            SetArmor();
            util.ReadInput("Choose your armor!: " + Who(oparm));
