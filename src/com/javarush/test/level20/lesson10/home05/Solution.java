    ...
    public static void main(String[] args) throws ClassNotFoundException,IOException
    {
        try
        {
            ...
            System.out.println(person.greetingString
                    ...
                    + " " + person.logger
                    + " " + person.outputStream);
            System.out.println(serialPerson.greetingString
                    + serialPerson.fullName
                    + " " + serialPerson.country
                    + " " + serialPerson.sex
                    + " " + serialPerson.logger
                    + " " + serialPerson.outputStream);
        }catch (NotSerializableException e) {e.getStackTrace();}
