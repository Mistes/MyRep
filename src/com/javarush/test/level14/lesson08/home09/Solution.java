...
public class Solution
{
    public static void main(String[] args)
    {
        ...
        {
            System.out.println(ivan.name + " имеет заначку в размере " + money.getAmount() + " " + money.getCurrencyName());   //TODO need to think at this solution
        }
    }
    ...
    static class Person
    {
        ...
        Person(String name)
        {
            ...
            //Add your code here
            allMoney.add(0,new Hrivna());
            allMoney.add(1, new USD());
        }
